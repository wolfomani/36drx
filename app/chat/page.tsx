...
export default function ChatInterface() {
  ...
  const TOP_PADDING_GLOBAL_NAV = 96
  ...
  return (
    <div 
      className="min-h-screen w-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex flex-col items-center justify-center pt-16 px-4 pb-4"
    ...
    >
      ...
      <div className="flex flex-col w-full max-w-4xl flex-1 rounded-2xl overflow-hidden bg-gray-800/50 backdrop-blur-xl border border-gray-700 shadow-2xl">
        ...
        <form 
          ...
          className="p-4 border-t border-gray-700 bg-gray-900/50 backdrop-blur-lg"
        >
          <div
