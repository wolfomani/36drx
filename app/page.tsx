...
import { MessageSquare, Code, Smartphone, Lightbulb, Cloud } from "lucide-react"
    ...
    <div className="gradient-bg min-h-screen flex flex-col items-center justify-center p-4 pt-16">
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto py-20">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/chat">
            <Button className="btn-gradient text-white px-8 py-3 rounded-full text-lg font-semibold flex items-center justify-center">
          ...
          <Link href="/services">
            <Button
              variant="outline"
              className="border-2 border-drx-orange text-drx-orange px-8 py-3 rounded-full text-lg font-semibold hover:bg-drx-orange hover:text-black transition-colors bg-transparent"
            >
              استكشف خدماتنا
            </Button>
          </Link>
      ...
      <section className="py-20 w-full section-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-gray-800 p-8 rounded-2xl shadow-lg text-center border border-gray-700 hover:border-drx-orange transition-all card-hover">
